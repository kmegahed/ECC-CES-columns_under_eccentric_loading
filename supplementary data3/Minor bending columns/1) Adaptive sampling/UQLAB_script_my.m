...
matFileName = 'C:\Users\osama\OneDrive\Desktop\abaqus2\X_Y_data1_my.mat';

% Define your model
ModelOpts.Name = 'my_model_,';
ModelOpts.mFile = 'model_my';%[30;30],[2;2.22],[40;30.1],[240;300]
...
function NextPoint = mySelectSample(iii, metaModel)
    ...
    EI = improvement .* normcdf(Z) + 10.0*gsigma .* normpdf(Z);
    %EI = normcdf(- gmean ./ gsigma);
